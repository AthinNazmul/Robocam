...
echo ""
echo "    Ubuntu 22.04 on Pi: CSI cameras (Pi Camera) are NOT supported"
echo "    Reason: libcamera not available in Ubuntu 22.04 ARM repos"
echo ""
echo "    ✓ USB cameras work fine"
echo "    ✓ All robocam features work with USB cameras"
echo "    ✓ For CSI cameras: Use official Raspberry Pi OS"
echo ""
